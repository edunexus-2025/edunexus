      ...
      <Card className="shadow-xl bg-gradient-to-r from-primary to-accent text-primary-foreground p-6 md:p-8 rounded-xl">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-lg text-primary-foreground/80 mt-1">Ready to conquer your exams on The Online Test Platform? Let's get started.</p>
          </div>
      ...
      <Card className="shadow-lg">
         <CardHeader className="flex flex-col md:flex-row justify-between items-start md:items-center">
          <div>
            ...
            <CardDescription>
              Find teachers, test series, or specific topics on The Online Test Platform.
            </CardDescription>
          </div>
          <Button
            variant="default"
